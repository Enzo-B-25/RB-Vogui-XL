...
if __name__ == "__main__":
    video2 = Commande()
    video2.SetStartStream('192.168.0.128', 5000, 2)
    video2.SetStartDD('192.168.0.128', 5000, 2)
    video2.SetStopStream('192.168.0.128', 5000, 2)
    video2.SetStopDD('192.168.0.128', 5000, 2)
    print("[TEST] Commande brute envoyée :", video2.data)
    print("[TEST] Type de commande :", video2.getTypeCommande())
    print("[TEST] Paramètres extraits :", video2.GetParamStream())
    video2.StartStream()
